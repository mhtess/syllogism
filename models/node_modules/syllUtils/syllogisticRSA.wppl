var syllogisticRSA = function(prems, cncl, params, opts){
  ...
  var prior = pruneERP(equivalentTransform(objects, baseRate))
  ...
  var reasoner0 = cache(function(premises, cncl, prior, QUD_E1) {
    Enumerate(function(){
      ...
      var utteranceProbs = conclusionTrue ? [1,cost] : [1, 0]
  ...
  var reasoner1 = function(premises, cncl, prior, QUD_E1, QUD_cL0) {
    Enumerate(function(){
      var state = sample(prior)
      // mapping from worlds to sentences, conclusions
      var trueSentences = stateToSentence(state)
  ...
  return reasoner1(prems, cncl, prior, QUD_E1, QUD_cL0)
