var M01_LIT_PRAG_BELIEF = function(){
    ...
    var noise = uniformDrift({a: 0, b: 0.1, width: 0.01})
		...
		// [0.85, 0.05, 0.5, 0.85, 0.5, 0.5, 0.75]
		...
		// var regionParams = {
		// 	"A_C_AB_BC_AC_ABC": uniformDrift({a: 0, b: 1, width: 0.1}),
		// 	"B": uniformDrift({a: 0, b: 1, width: 0.1})
		// }
		//
		// // C, B, BC, A,  AC, AB, ABC
		// var regionProbs = [
		// 	regionParams.A_C_AB_BC_AC_ABC,
		// 	regionParams.B,
		// 	regionParams.A_C_AB_BC_AC_ABC,
		// 	regionParams.A_C_AB_BC_AC_ABC,
		// 	regionParams.A_C_AB_BC_AC_ABC,
    ...
    // var regionProbs = [
		...
		var regionParams = {
			"A_B_C_AB_BC_AC_ABC": uniformDrift({a: 0, b: 1, width: 0.1})
		}
