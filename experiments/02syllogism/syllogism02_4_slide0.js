   ...
   //    };
	...
	priors: function() {
        ...
        // 111, 110, 101, 011, 100, 010, 001, 000
		 	propPermute = [trial.S+", " + trial.M + ", and "+trial.P, 
      trial.S+", " + trial.M + ", and not " + trial.P, 
      trial.S+", " + trial.P + ", and not "+trial.M, 
      trial.P+", " + trial.M + ", and not "+trial.S, 
      trial.S+", not " + trial.M + ", and not "+trial.P, 
      trial.M+", not " + trial.P + ", and not "+trial.S, 
      trial.P+", not " + trial.M + ", and not "+trial.S, 
      "not " + trial.S+", not " + trial.M + ", and not "+trial.P];
