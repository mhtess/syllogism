...
We discuss the implications of this finding in the context of other work on pragmatic reasoning with syllogisms and describe how the modeling approach we present here could naturally be extended to account for other phenomena in syllogistic reasoning.
...
Our modeling approach to pragmatic speakers also provides a clear, interpretable mechanism by which \emph{nothing follows} can be rationally produced. 
...
This model serves as a substantial contribution to the syllogistic reasoning literature, as the formalization and treatment of the \emph{nothing follows} conclusion is something that has been missed from extant proposals \cite{riesterer2020modeling}.
