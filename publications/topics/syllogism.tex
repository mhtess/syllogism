...
In a famous scientific expedition of the 1930s, the psychologist Alexander Luria set off into the remote areas of Uzbekistan and Kyrgyzstan in the former Soviet Union to understand the mind of the Russian peasant. Among his experiments, Luria would give the peasants verbal reasoning problems such as the following:
...
The kind of response Luria received depended in part on the literacy of his participant. 
...
In this paper, we take seriously the idea that syllogistic reasoning involves 
...
We develop a set of models in the Rational Speech Act framework \cite{Frank2012a, goodman2016pragmatic} that vary in how they interpret the premises of the syllogism and decide upon a conclusion that follows.
