...
\pgfplotstabletypeset[sci zerofill,
   ...
   columns/mse/.style={fixed, column name={$MSE$}, column type = l, dec sep align, precision=4}
     ]{csv_to_tex/altModels_stats.csv}\caption{Summary statistics for alternative models. Individual-level models use a new set of parameters for each individual participant in the data set ($n=139$).}\label{tab:altStats}
\end{table}
\end{center}
