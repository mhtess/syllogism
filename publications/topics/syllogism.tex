...
\label{Pragmatic interpretation of premises}
...
\subsubsection{Literal production of conclusion}
...
Given a belief updating model based on the premises of a syllogism, we can define a literal production model $S_0$ that uses $L_0$'s posterior distribution on states to determine what conclusion is likely to be true given the premises. 
...
\begin{equation}
R_0(u_3 \mid u_1, u_2) \propto \sum_s P(u_3\mid s) \cdot L_0(s \mid u_1, u_2)
\end{equation}
