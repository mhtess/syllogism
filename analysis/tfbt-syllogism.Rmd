...
data.obs = subset(df.c, (condition=='radio.2'))[,c("subj","syll","domain","radio_A","radio_E","radio_I","radio_O")] # subset data condition==radio and take only radio button vals
...
ggsave(filename = paste('literalEP',EP,'_posteriorN_exp2.png',sep=''),plot1, width=16, height=12)
...
ggsave(filename = paste('literalEP',EP,'_posteriorPhi_exp2.png',sep=''),plot2, width=16, height=12)
