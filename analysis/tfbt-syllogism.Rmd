...
```{r}
library(polspline)
church.post<-read.csv('post_alpha-beta_mh1000_100_f3_lightbulb.csv',header=F)
...
ggplot(data=post.m,aes(x=value,fill=variable))+
...
ggplot(data=church.post,aes(x=alpha))+
  geom_density(alpha=0.8)
```
