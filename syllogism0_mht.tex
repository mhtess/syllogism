...
\todo{existential presuposiotion?}
...
(query
 ...
 (and (conclusion A C) 
      ...
      (premise-two B C)))
\end{lstlisting}
And this defines our Conditional Semantics model.
