...
\cline{3-7}
& & \multicolumn{5}{ c| }{Model} \\ \cline{3-7}
& & Prior & Literal & PQR$_{0,1}$ & PQR$_{1,0}$ & PQR$_{1,1}$ \\ \cline{1-7}
\multicolumn{1}{ |c| }{\multirow{2}{.08\columnwidth}{Correct modal responses} } &
\multicolumn{1}{ |c| }{Valid} & 5 & 17 & 17 & 21 & 20    \\ \cline{2-7}
\multicolumn{1}{ |c  }{}                        &
\multicolumn{1}{ |c| }{Invalid} & 24 & 20 & 24 & 21 & 21    \\ \cline{1-7}
\multicolumn{1}{ |c  }{\multirow{2}{.08\columnwidth}{Correlation} } &
\multicolumn{1}{ |c| }{Valid} & -0.46 & -0.21 & 0.69 & 0.82 & 0.85 \\ \cline{2-7}
\multicolumn{1}{ |c  }{}                        &
\multicolumn{1}{ |c| }{Invalid} & 0.42 & 0.62 & 0.72 & 0.63 & 0.58 \\ \cline{1-7}
\end{tabular}
\end{Table}
