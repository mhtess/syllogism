...
top16<-oed.ccee[order(-oed.ccee$kl)[seq(1,16,4)],]
fpath<-'/Users/mht/Documents/research/syllogism/data/03syllogism_prior_psychjs/'
...
ggplot(data=subset(mm.df,substrRight(as.character(variable),3)%in%c("Isp","Osp")),aes(x=domain,y=value))+
  geom_bar(aes(alpha=conclusion,fill=model),stat='identity',position='dodge')+
  facet_wrap(~X..syll)+
