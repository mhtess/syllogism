...
```{r FBT.params}
setwd('Documents/MHT//syllogism-project/models/FBT')
#d<-read.csv('../models/FBT/n4Marginal_posteriorD_wPrior_test_1000.csv')

setwd('C:/Users/Henry/Documents/RESEARCH/syllogism-project/models/FBT/')
d<-read.csv('../../models/FBT/exp12_n4Marginal_r0_independent_10000a_combined.csv')
d<-read.csv('../../models/FBT/exp12_n4Marginal_r0_independent_10000b_combined.csv')
d<-read.csv('../../models/FBT/exp12_n4Marginal_r0_naive_10000b_combined.csv')
d<-read.csv('../../models/FBT/exp12_n4Marginal_r0_iid_10000a_combined.csv')
d<- bind_rows(d,d1)
