...
Map radio values to continuous values
...
exp_domains = c('cracker','knife','lightbulb','strawberry')
quantifiers = c("All","None","Some","Some_not")
...
ggplot(ci_bs, aes(x=conclusion, y=value, fill=condition)) + 
