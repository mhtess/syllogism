...
```{r}
fpath = '~/Documents/MHT/syllogism-project/data/03syllogism_reasoning/'
fpath2 = '~/Documents/MHT/syllogism-project/data/04syllogism_reasoning/'
fpath = 'C:/Users/Henry/Documents/RESEARCH/syllogism-project/data/03syllogism_reasoning/'
...
models <- left_join(independent, empirical, by=c("syllog","domain","conclusion"))
...
ggplot(dm.sub, 
       aes(x=conclusion, y = value, fill = conclusion, alpha = type))+
  geom_bar(stat='identity', 
...
dm.sub$conclusion<-factor(dm.sub$conclusion, levels = c(
  "all","some","not all","none"))
