...
d<-read.csv('exp12_n4Marginal_r0_independent_10000a_combined.csv')
d<-read.csv('exp12_n4Marginal_r0_independent_10000b_combined.csv')
d<-read.csv('exp12_n4Marginal_r0_naive_10000b_combined.csv')
d<-read.csv('exp12_n4Marginal_r0_iid_10000a_combined.csv')
d<- bind_rows(d,d1)
d<-read.csv('exp12_n4Marginal_r0_empirical_10000a_combined.csv')
...
with(dm, cor(human, model))

ggplot(dm, aes(x=model, y=human, color=conclusion))+
  geom_point(size=2)+
  theme_bw()+
  xlim(0,0.6)+
  ylim(0,0.6)+
...
dm.tidy<- dm %>% 
  gather(type, value, human, model)


ggplot(dm.tidy, aes(x=conclusion, y = value, fill = conclusion, alpha = type))+
